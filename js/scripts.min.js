...
$(function(){new Typed(".typed-text",{strings:["Front-end developer "],typeSpeed:100});$(".page-header__portfolio-link a").mPageScroll2id(),$(".page-header").parallax({imageSrc:"img/top-bg-compressor.jpg",zindex:0})});